...
def translations(request, lang):
    ...
    response = JsonResponse({
        "trans": {
            ...
            'Model-maps-provide-information-to-help-better-unde': _('Model-maps-provide-information-to-help-better-unde'),
            'These-estimates-are-generated-monthly-for-each-of': _('These-estimates-are-generated-monthly-for-each-of'),
            'The-map-currently-shows-estimates-for-all-countrie': _('The-map-currently-shows-estimates-for-all-countrie'),            
